<template>
  <article class="text-gray-900 dark:text-white text-lg">
    ...
    <blockquote class="px-4 border-s-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
      ...
      <br />
      <p>
        As a <strong>teacher</strong>, I help students grasp the fundamentals of programming, guiding them through
        problem-solving, best practices, and project-based learning.
      </p>
    </blockquote>
    <br />
    <p>
      I'm always eager to collaborate, innovate, and contribute to meaningful projects. Let's build something amazing
      together!
    </p>
  </article>
</template>